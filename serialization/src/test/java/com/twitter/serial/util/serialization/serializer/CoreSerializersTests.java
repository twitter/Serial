...
import com.twitter.serial.util.SerializationTestUtils;
import com.twitter.serial.util.object.ObjectUtils;
import com.twitter.serial.util.serialization.base.ByteBufferSerial;
import com.twitter.serial.util.serialization.base.Serial;
...
public class CoreSerializersTests {
    ...
    @Test
    public void testSerializeComparator() throws Exception {
        final Serializer<Comparator<SerializationTestUtils.TestObject>> testObjectComparatorSerializer =
                CoreSerializers.getComparatorSerializer();
        SerializationTestUtils.checkSerialization(ObjectUtils.<SerializationTestUtils.TestObject>getComparator(),
                testObjectComparatorSerializer);
    }

    @Test(expected = IllegalStateException.class)
    public void testExceptionForUndefinedDefaultConstructor() throws Exception {
        final Serializer<Comparator<SerializationTestUtils.TestObject>> comparatorSerializer =
                CoreSerializers.getComparatorSerializer();
        SerializationTestUtils.checkSerialization(new SerializationTestUtils.InvalidTestObjectComparator(1),
                comparatorSerializer);
    }

    @Test
    public void testSerializeCustomComparator() throws Exception {
        final Serializer<Comparator<SerializationTestUtils.TestObject>> comparatorSerializer =
                CoreSerializers.getComparatorSerializer();
        SerializationTestUtils.checkSerialization(
                new SerializationTestUtils.TestObjectComparator(), comparatorSerializer);
    }
