...
import com.twitter.serial.util.serialization.base.ByteBufferSerializerInput;
import com.twitter.serial.util.serialization.base.ByteBufferSerializerOutput;
import com.twitter.serial.util.serialization.base.OptionalFieldException;
...
public class ByteBufferSerializationTests {
    ...
    public void testVersionNumbers() throws Exception {
        ...
        final ByteBufferSerializerInput input = new ByteBufferSerializerInput(bytes);
        final int v1 = input.readObjectStart();
        assertThat(v1).isEqualTo(1);
        assertThat(
                (Object) SerializationTestUtils.TestObject.V1_SERIALIZER.deserializeObject(mContext,
                        input, v1))
                .isEqualToComparingFieldByField(new SerializationTestUtils.TestObject("t1", 2));
        input.readObjectEnd();

        final int v0 = input.readObjectStart();
        assertThat(v0)
                .isZero();
        assertThat(
                (Object) SerializationTestUtils.TestObject.V1_SERIALIZER.deserializeObject(mContext,
    ...
    @Test(expected = OptionalFieldException.class)
    public void testOptionalField() throws Exception {
        final byte[] bytes = new ByteBufferSerializerOutput()
                .writeObject(mContext,
                        new TestObjectV2("tv2", 2, 3), SerializationTestUtils.TestObject.SERIALIZER)
                .getSerializedData();
        TestObjectV2.SERIALIZER.deserialize(mContext, new ByteBufferSerializerInput(bytes));
    }
    ...
    private static class TestObjectV2 extends SerializationTestUtils.TestObject {
        ...
        private static class TestObjectV2Serializer extends ObjectSerializer<TestObjectV2> {
            ...
            protected void serializeObject(@NotNull SerializationContext context,
                    ...
                    throws IOException {
                SerializationTestUtils.TestObject.SERIALIZER.serializeObject(context,
                        output, object);
            ...
            protected TestObjectV2 deserializeObject(@NotNull SerializationContext context,
                ...
                final SerializationTestUtils.TestObject t =
                        SerializationTestUtils.TestObject.SERIALIZER.deserializeObject(context,
                                input, versionNumber);
