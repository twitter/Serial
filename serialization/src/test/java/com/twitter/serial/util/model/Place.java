...
package com.twitter.serial.util.model;

import com.twitter.serial.util.internal.InternalSerialUtils;
import com.twitter.serial.util.object.ObjectBuilder;
...
import com.twitter.serial.util.serialization.serializer.BuilderSerializer;
import com.twitter.serial.util.serialization.serializer.CoreSerializers;
...
public class Place {
    ...
    public boolean equals(Object o) {
        ...
        return placeId.equals(place.placeId)
                ...
                && ObjectUtils.equals(boundingBox, place.boundingBox)
                && ObjectUtils.equals(centroid, place.centroid)
                && ObjectUtils.equals(country, place.country)
                && ObjectUtils.equals(countryCode, place.countryCode)
                && ObjectUtils.equals(address, place.address)
                && ObjectUtils.equals(handle, place.handle);
    }

    @Override
    public int hashCode() {
        return ObjectUtils.hashCode(placeId, placeType, name, boundingBox, centroid, country,
