...
import com.twitter.serial.util.StringUtils;
import com.twitter.serial.util.internal.Pools;
import com.twitter.serial.util.model.Place;
import com.twitter.serial.util.model.SampleDataProvider;
...
public class SerializationUtilsTests {
    ...
    public void testDumpSerializedData() throws IOException {
        ...
        output.writeByte((byte) 2)
                ...
                .writeNull()
                .writeString("")
                .writeString("test with" + StringUtils.lineSeparator() + "a linebreak.");
    ...
    public void testDumpSerializedData_UnmatchedObjectStart() throws IOException {
        ...
        assertThat(SerializationUtils.dumpSerializedData(output.getSerializedData()))
                .isEqualTo("{\n" +
                        ...
                        "            Long: 99\n" +
                        "        }\n" +
                        "ERROR: com.twitter.serial.serialization.base.SerializationException: " +
